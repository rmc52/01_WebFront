...
input3.addEventListener("keyup", function(e) {
  //console.log(e);
  if(e.key == "Enter") {
    document.querySelector("#box3").style.backgroundColor = input3.value;
  }
});
...
box3.addEventListener("click", function(e) {
  ...
  //const bgColor = box3.style.backgroundColor;
  //alert(`배경색은 ${bgColor} 입니다.`);
  alert(`배경색은 ${e.target.style.backgroundColor} 입니다.`);
});